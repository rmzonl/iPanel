...
php_admin_value[open_basedir] = $IPANEL_ROOT/web:/tmp:/var/log/ipanel:/etc/ipanel:/etc/nginx:/home:/usr/share/phpmyadmin:/usr/share/phpMyAdmin:/var/www:/usr/local/nvm:/var/backups/ipanel
EOF
